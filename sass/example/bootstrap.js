...
Ext.Loader.addClassPathMappings({
  ...
  "Ext.cmd": "../../../../../../Users/DutchMokutan/bin/Sencha/Cmd/6.1.3.42/plugins/src",
  ...
  "Instinct": "../../app",
  "settings": "../../app/controller/client/settings.js",
  "sqlite": "../../app/controller/nativeFunctions/Sqlite.js"
});
...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "Instinct.controller.Main": [],
  "Instinct.controller.client.database": [],
  "Instinct.controller.client.settings": [],
  "Instinct.controller.main.Menu": [],
  "Instinct.controller.nativeFunctions.Sqlite": [],
  "Instinct.controller.nativeFunctions.cameraPlugin": [],
  "Instinct.controller.nativeFunctions.cordova": [],
  "Instinct.controller.nativeFunctions.devicePlugin": [],
  "Instinct.controller.server.checkPlayerData": [],
  "Instinct.controller.server.sendData": [],
  "Instinct.controller.server.versionControl": [],
  "Instinct.controller.user.Login": [],
  "Instinct.controller.user.Register": [],
  "Instinct.controller.user.Verify": [],
  "Instinct.model.user.Session": [],
  "Instinct.store.user.Session": [],
  "Instinct.view.Holder": [],
  "Instinct.view.Main": [],
  "Instinct.view.intro.Main": [],
  "Instinct.view.main.Menu": [],
  "Instinct.view.mainViewport": [],
  "Instinct.view.user.Login": [],
  "Instinct.view.user.Register": [],
  "Instinct.view.user.VerifyAccount": [],
  "settings": [],
  "sqlite": []
});
